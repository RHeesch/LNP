...
positions = ['posi_1','posi_2','posi_3','posi_4','posi_5','posi_6','posi_7','posi_8','posi_9','posi_10','posi_11','posi_12','posi_13','posi_14','posi_15','posi_16','posi_17','posi_18']
list_of_positions = []
position, list_of_positions = z3.EnumSort('position', positions)

prepos = ['prepo_1','prepo_2','prepo_3','prepo_4','prepo_5','prepo_6','prepo_7','prepo_8','prepo_9','prepo_10','prepo_11','prepo_12','prepo_13','prepo_14','prepo_15','prepo_16','prepo_17','prepo_18']
list_of_prepos = []
...
def nn_inf(call, s, P_in, Weights):
    ...
    for p in range(n_N_L_1):
        s.add(z3.Implies((P_in[list_of_positions[0]] * List_W_L1[call][list_of_positions[p]][list_of_prepos[0]]
                        ...
                        + P_in[list_of_positions[9]] * List_W_L1[call][list_of_positions[p]][list_of_prepos[9]]
                        + P_in[list_of_positions[10]] * List_W_L1[call][list_of_positions[p]][list_of_prepos[10]]
                        + P_in[list_of_positions[11]] * List_W_L1[call][list_of_positions[p]][list_of_prepos[11]]
                        + P_in[list_of_positions[12]] * List_W_L1[call][list_of_positions[p]][list_of_prepos[12]]
                        + P_in[list_of_positions[13]] * List_W_L1[call][list_of_positions[p]][list_of_prepos[13]]
                        + P_in[list_of_positions[14]] * List_W_L1[call][list_of_positions[p]][list_of_prepos[14]]
                        + P_in[list_of_positions[15]] * List_W_L1[call][list_of_positions[p]][list_of_prepos[15]]
                        + P_in[list_of_positions[16]] * List_W_L1[call][list_of_positions[p]][list_of_prepos[16]]
                        + P_in[list_of_positions[17]] * List_W_L1[call][list_of_positions[p]][list_of_prepos[17]]
    ...
    for p in range(n_N_L_2):
        s.add(z3.Implies((List_P_L1[call][list_of_positions[0]] * List_W_L2[call][list_of_positions[p]][list_of_prepos[0]]
                        ...
                        + List_P_L1[call][list_of_positions[9]] * List_W_L2[call][list_of_positions[p]][list_of_prepos[9]]
                        + List_P_L1[call][list_of_positions[10]] * List_W_L2[call][list_of_positions[p]][list_of_prepos[10]]
                        + List_P_L1[call][list_of_positions[11]] * List_W_L2[call][list_of_positions[p]][list_of_prepos[11]]
                        + List_P_L1[call][list_of_positions[12]] * List_W_L2[call][list_of_positions[p]][list_of_prepos[12]]
                        + List_P_L1[call][list_of_positions[13]] * List_W_L2[call][list_of_positions[p]][list_of_prepos[13]]
                        + List_P_L1[call][list_of_positions[14]] * List_W_L2[call][list_of_positions[p]][list_of_prepos[14]]
                        + List_P_L1[call][list_of_positions[15]] * List_W_L2[call][list_of_positions[p]][list_of_prepos[15]]
                        + List_P_L1[call][list_of_positions[16]] * List_W_L2[call][list_of_positions[p]][list_of_prepos[16]]
                        + List_P_L1[call][list_of_positions[17]] * List_W_L2[call][list_of_positions[p]][list_of_prepos[17]] 
    ...
    for p in range(n_N_L_3):
        s.add(z3.Implies((List_P_L2[call][list_of_positions[0]] *  List_W_L3[call][list_of_positions[p]][list_of_prepos[0]]
                        ...
                        + List_P_L2[call][list_of_positions[9]] *  List_W_L3[call][list_of_positions[p]][list_of_prepos[9]]
                        + List_P_L2[call][list_of_positions[10]] * List_W_L3[call][list_of_positions[p]][list_of_prepos[10]]
                        + List_P_L2[call][list_of_positions[11]] * List_W_L3[call][list_of_positions[p]][list_of_prepos[11]]
                        + List_P_L2[call][list_of_positions[12]] * List_W_L3[call][list_of_positions[p]][list_of_prepos[12]]
                        + List_P_L2[call][list_of_positions[13]] * List_W_L3[call][list_of_positions[p]][list_of_prepos[13]]
                        + List_P_L2[call][list_of_positions[14]] * List_W_L3[call][list_of_positions[p]][list_of_prepos[14]]
                        + List_P_L2[call][list_of_positions[15]] * List_W_L3[call][list_of_positions[p]][list_of_prepos[15]]
                        + List_P_L2[call][list_of_positions[16]] * List_W_L3[call][list_of_positions[p]][list_of_prepos[16]]
                        + List_P_L2[call][list_of_positions[17]] * List_W_L3[call][list_of_positions[p]][list_of_prepos[17]]  
                        + List_B_L3[call][list_of_positions[p]][list_of_prepos[p]]
                        ) <= 0, List_P_L3[call][list_of_positions[p]] == 0))
        s.add(z3.Implies((List_P_L2[call][list_of_positions[0]] *  List_W_L3[call][list_of_positions[p]][list_of_prepos[0]]
                        + List_P_L2[call][list_of_positions[1]] *  List_W_L3[call][list_of_positions[p]][list_of_prepos[1]]
                        + List_P_L2[call][list_of_positions[2]] *  List_W_L3[call][list_of_positions[p]][list_of_prepos[2]]
                        + List_P_L2[call][list_of_positions[3]] *  List_W_L3[call][list_of_positions[p]][list_of_prepos[3]]
                        ...
                        + List_P_L2[call][list_of_positions[17]] * List_W_L3[call][list_of_positions[p]][list_of_prepos[17]] 
                        + List_B_L3[call][list_of_positions[p]][list_of_prepos[p]]
                        ) > 0, List_P_L3[call][list_of_positions[p]] == 
    ...
    for p in range(n_N_L_4):
        s.add(z3.Implies((List_P_L3[call][list_of_positions[0]] * List_W_L4[call][list_of_positions[p]][list_of_prepos[0]]
                        ...
                        + List_P_L3[call][list_of_positions[9]] *  List_W_L4[call][list_of_positions[p]][list_of_prepos[9]]
                        + List_P_L3[call][list_of_positions[10]] * List_W_L4[call][list_of_positions[p]][list_of_prepos[10]]
                        + List_P_L3[call][list_of_positions[11]] * List_W_L4[call][list_of_positions[p]][list_of_prepos[11]]
                        + List_P_L3[call][list_of_positions[12]] * List_W_L4[call][list_of_positions[p]][list_of_prepos[12]]
                        + List_P_L3[call][list_of_positions[13]] * List_W_L4[call][list_of_positions[p]][list_of_prepos[13]]
                        + List_P_L3[call][list_of_positions[14]] * List_W_L4[call][list_of_positions[p]][list_of_prepos[14]]
                        + List_P_L3[call][list_of_positions[15]] * List_W_L4[call][list_of_positions[p]][list_of_prepos[15]]
                        + List_P_L3[call][list_of_positions[16]] * List_W_L4[call][list_of_positions[p]][list_of_prepos[16]]
                        + List_P_L3[call][list_of_positions[17]] * List_W_L4[call][list_of_positions[p]][list_of_prepos[17]] 
                        + List_B_L4[call][list_of_positions[p]][list_of_prepos[p]]
                        ) <= 0, List_P_L4[call][list_of_positions[p]] == 0))
        s.add(z3.Implies((List_P_L3[call][list_of_positions[0]] * List_W_L4[call][list_of_positions[p]][list_of_prepos[0]]
                        + List_P_L3[call][list_of_positions[1]] * List_W_L4[call][list_of_positions[p]][list_of_prepos[1]]
                        + List_P_L3[call][list_of_positions[2]] * List_W_L4[call][list_of_positions[p]][list_of_prepos[2]]
                        + List_P_L3[call][list_of_positions[3]] * List_W_L4[call][list_of_positions[p]][list_of_prepos[3]]
                        ...
                        + List_P_L3[call][list_of_positions[17]] * List_W_L4[call][list_of_positions[p]][list_of_prepos[17]] 
                        + List_B_L4[call][list_of_positions[p]][list_of_prepos[p]]
                        ) > 0, List_P_L4[call][list_of_positions[p]] == 
